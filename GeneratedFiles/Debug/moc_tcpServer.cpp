...
QT_MOC_LITERAL(1, 10, 12), // "onUpdateView"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "title"
QT_MOC_LITERAL(4, 30, 10), // "initServer"
QT_MOC_LITERAL(5, 41, 13) // "newConnection"

    },
    "tcpServer\0onUpdateView\0\0title\0initServer\0"
    "newConnection"
};
...
void tcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onUpdateView((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->initServer(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&tcpServer::onUpdateView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void tcpServer::onUpdateView(const QString & _t1)
{
