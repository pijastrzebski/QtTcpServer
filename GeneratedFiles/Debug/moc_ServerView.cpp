...
QT_MOC_LITERAL(3, 23, 5) // "title"
    ...
    "ServerView\0updateView\0\0title"
};
...
void ServerView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ServerView *_t = static_cast<ServerView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateView((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ServerView::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ServerView.data,
      qt_meta_data_ServerView,  qt_static_metacall, nullptr, nullptr}
};
